"""Ablation experiments for HW preprocessing and IF ensemble fusion.

Produces a synthetic, realistic-looking container-monitoring dataset with time-series
characteristics, then runs four experiments:
 1) single IF, no HW
 2) single IF, with HW
 3) IF ensemble fusion, no HW
 4) IF ensemble fusion, with HW

Outputs CSV/MD/PNG summary in monitoring_results/
"""
